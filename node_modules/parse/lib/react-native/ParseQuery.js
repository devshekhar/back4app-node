...
class ParseQuery {
  ...
  aggregate(pipeline, options) {
    ...
    return controller.aggregate(this.className, { pipeline }, aggregateOptions).then(results => {
      return results.results;
    });
  }
  ...
  */
   ...
   * @return {Parse.Query} Returns the query, so you can chain this call.
   */
  withinRadians(key, point, distance, sorted) {
   ...
   * @return {Parse.Query} Returns the query, so you can chain this call.
   */
  withinMiles(key, point, distance, sorted) {
   ...
   * @return {Parse.Query} Returns the query, so you can chain this call.
   */
  withinKilometers(key, point, distance, sorted) {
