...
var DefaultController = {
  ...
  sendRequest: function (method, url, body) {
    return _CoreManager2.default.getRESTController().request(method, url, body, { useMasterKey: true }).then(function (res) {
      ...
      if (decoded) {
        return _promise2.default.resolve(decoded);
      }
      return _promise2.default.reject(new _ParseError2.default(_ParseError2.default.INVALID_JSON, 'The server returned an invalid response.'));
    });
  }
};
